...
/*
Accepts a series of components and connects them to produce a function that accepts a pointer
to a ComponentContext struct. This functions invokes
*/
...
/*
Creates the ComponentContext and uses it to start handling requests
*/
